...
from layers.edgeconv_layer import EdgeConv_reorg as EdgeConv
import time
...
print('train time:',(end-start)/args.num_epochs)
# print(edgeconv_time)
# print(np.mean(edgeconv_time[10:]))

# with open('profile_train_no_batchnorm.txt','w') as f:
#     print(prof.key_averages(group_by_input_shape=True).table(sort_by="self_cuda_time_total", row_limit=50),file=f)