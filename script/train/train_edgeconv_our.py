...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            src,dst=g.edges()
            h = self.conv[i](self.k,src.int(),h)
...
with open("../{}".format(args.output),'a') as f:
    print("train_edgeconv_our,dataset=modelnet40,k={},batch={},latency={}s,memory={}MB".format(args.k,args.batch_size,train_time,maxMemory),file=f) 
