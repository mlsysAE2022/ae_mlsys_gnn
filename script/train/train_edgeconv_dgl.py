...
import sys
sys.path.append('../..')
from layers.edgeconv_layer import EdgeConv_dgl as EdgeConv
import time
...
train_time=(end-start)/args.num_epochs/(7872/args.batch_size)
print('train time:',train_time)

with open("../{}".format(args.output),'a') as f:
    print("train_edgeconv_dgl,dataset=modelnet40,k={},batch={},latency={}s,memory={}MB".format(args.k,args.batch_size,train_time,maxMemory),file=f) 
