    ...
    torch::Tensor grad)
{
    ...
    return gat_backward_cuda(negative_slope, row_ptr, col_ind, col_ptr, row_ind, permute, edge_max, edge_sum, in_feat, attn_row, attn_col, grad);
}

PYBIND11_MODULE(fused_gat_stash, m)
{
